...
managed in one place. CRUD per module (office copilot can drive all of it):

| Module | Create | Read | Update | Delete |
|---|---|---|---|---|
| Teachers | add (email, dept, subjects) | directory, profile, allotments | dept / subjects / allotments | deactivate; allotments freed, shared notes stay |
| Classes | open grade + subject set | sections, strength, teachers | reconfigure subjects | archive at year end |
| Sections | add under a class | roster + allotted teachers | move students, swap teacher | merge/close |
| Students | admit (roll, section, parents) | profile: marks, attendance, homework | section / contacts | transfer out, record archived |
| Subjects & books | add subject, attach books | who it serves | new edition → libraries | retire at rollover |
| Allotments | automation proposes, office confirms | one allotment board | swaps, covers (or ask copilot) | release |
